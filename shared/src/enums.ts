...
export const AUDIT_EVENT_TYPES = [
  ...
  "COMMUNITY_RESPONDED",
  "DONATION_RECORDED",
  "REQUISITION_ESCALATION_STARTED",
  "REQUISITION_SEARCH_STARTED",
  "UNIT_RESERVATION_ATTEMPTED",
  "UNIT_RESERVED",
  "UNIT_RESERVATION_REJECTED",
  "REQUISITION_PARTIALLY_FULFILLED",
  "REQUISITION_FULFILLED",
  "DONOR_ESCALATION_STARTED",
  "REQUISITION_EXHAUSTED",
  "REQUISITION_EXPIRED",
  "REQUISITION_CANCEL_REQUESTED",
  "UNIT_RESERVATION_RELEASED",
  "COMMUNITY_ALERT_CANCELLED",
  "REQUISITION_ESCALATION_CANCELLED",
