...
export function DonatePage() {
  ...
  return (
    <InteractivePinkBackground className="text-[#1A1A1A] font-sans antialiased selection:bg-[#B71C1C]/15 selection:text-[#B71C1C]">
          ...
          <nav className="flex items-center gap-6 sm:gap-10">
            <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-[#4A4A4A]">
              ...
              <button
                ...
                className="text-[#B71C1C] font-bold transition-colors flex items-center gap-1.5"
              >
      ...
      {/* ── Main Content: Find Where to Donate ────────────────────────────── */}
      <main className="py-12 sm:py-20 px-6 sm:px-12 lg:px-16 max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-[#111111] leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            ...
            <div className="md:col-span-6 relative">
              ...
              <div className="relative flex items-center">
                ...
                >
                  <Navigation
                    className={`w-3.5 h-3.5 ${isLocating ? "animate-spin text-[#B71C1C]" : ""}`}
                  />
      ...
      <footer className="bg-white/40 backdrop-blur-md border-t border-black/5 py-12 px-6 sm:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-[#777777]">
          ...
          <div className="flex items-center gap-6 font-medium">
            ...
            <button onClick={() => navigate("/donate")} className="text-[#B71C1C] font-bold">Donate</button>
