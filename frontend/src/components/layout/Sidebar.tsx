...
export function Sidebar() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="px-5 py-4 border-t border-white/15 bg-black/20 backdrop-blur-xs">
            ...
            <button
              ...
              className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-white/90 transition-all hover:bg-white/15 hover:text-white group cursor-pointer"
            >
      ...
      {isLoggingOut && <BloodDropIntro onComplete={handleLogoutComplete} />}
    </>
  );
}
